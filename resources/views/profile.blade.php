            ...
            <div class="user-info">
                ...
                <div class="profile-photo">
                    ...
                    <button class="upload-btn1" type="button">
                        <img src="{{ Auth::user()->profile_picture ? asset('storage/' . Auth::user()->profile_picture) : asset('assets/images/upload-image.png') }}"
                            width="100" height="100" style="border-radius: 50%; object-fit:contain"
                            alt="profile Picture" class="preview1">
                    </button>
                ...
                <div class="user-details">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ Auth::user()->name }}" id="FName"
                            placeholder="Tanvir Hossen">
                        <img src="assets/images/edit-2.png" alt="edit icon varasa">
                    </div>
                    <div>
                        <label for="Email">Email</label>
                        <input type="email" readonly name="email" value="{{ Auth::user()->email }}" id="Email"
