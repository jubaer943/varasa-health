...
@section('content')
    ...
    <!-- page section start -->
    <div class="page-body">
        <a class="go_back" href="{{ route('campaign.index') }}">
            ...
            <div class="user-info">
                ...
                <div class="Campaign-Banner">
                    ...
                    <button class="upload-btn1" type="button">
                        <img src="{{ asset('assets/images/upload-image.png') }}" class="preview1" alt="profile Picture">
                    </button>
                ...
                <button type="submit" class=" button">Run Campaign</button>
            </div>
            <!-- user info end -->
        </form>
    </div>
